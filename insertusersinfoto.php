...
$sql = "INSERT INTO usuarios (user, contraseña, genero, edad, peso, altura) 
        VALUES ('$user', '$pass', '$genero', '$edad', '$peso', '$altura')";

// Ejecutar la sentencia SQL y verificar si se realizó con éxito
if ($conn->query($sql) === TRUE) {
    $response = array("status" => "success", "message" => "Usuario insertado con éxito.");
    echo json_encode($response);
} else {
